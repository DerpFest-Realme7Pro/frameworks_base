   ...
   public void update() {
    ...
    public void refreshTextFont() {
        ...
        switch (textFont) {
            case 0:
            default:
                return textView.setTypeface(Typeface.create(mContext.getResources().getString(R.string.clock_sysfont_headline), Typeface.NORMAL);
            case 1:
                return textView.setTypeface(Typeface.create(mContext.getResources().getString(R.string.clock_sysfont_body), Typeface.NORMAL);
            case 2:
                return textView.setTypeface(Typeface.create("sans-serif", Typeface.BOLD);
            case 3:
                return textView.setTypeface(Typeface.create("sans-serif", Typeface.NORMAL);
            case 4:
                return textView.setTypeface(Typeface.create("sans-serif", Typeface.ITALIC);
            case 5:
                return textView.setTypeface(Typeface.create("sans-serif", Typeface.BOLD_ITALIC);
            case 6:
                return textView.setTypeface(Typeface.create("sans-serif-light", Typeface.NORMAL);
            case 7:
                return textView.setTypeface(Typeface.create("sans-serif-thin", Typeface.NORMAL);
            case 8:
                return textView.setTypeface(Typeface.create("sans-serif-condensed", Typeface.NORMAL);
            case 9:
                return textView.setTypeface(Typeface.create("sans-serif-condensed", Typeface.ITALIC);
            case 10:
                return textView.setTypeface(Typeface.create("sans-serif-condensed", Typeface.BOLD);
            case 11:
                return textView.setTypeface(Typeface.create("sans-serif-condensed", Typeface.BOLD_ITALIC);
            case 12:
                return textView.setTypeface(Typeface.create("sans-serif-medium", Typeface.NORMAL);
            case 13:
                return textView.setTypeface(Typeface.create("sans-serif-medium", Typeface.ITALIC);
            case 14:
                return textView.setTypeface(Typeface.create("abelreg", Typeface.NORMAL);
            case 15:
                return textView.setTypeface(Typeface.create("adamcg-pro", Typeface.NORMAL);
            case 16:
                return textView.setTypeface(Typeface.create("adventpro", Typeface.NORMAL);
            case 17:
                return textView.setTypeface(Typeface.create("alien-league", Typeface.NORMAL);
            case 18:
                return textView.setTypeface(Typeface.create("archivonar", Typeface.NORMAL);
            case 19:
                return textView.setTypeface(Typeface.create("autourone", Typeface.NORMAL);
            case 20:
                return textView.setTypeface(Typeface.create("badscript", Typeface.NORMAL);
            case 21:
                return textView.setTypeface(Typeface.create("bignoodle-regular", Typeface.NORMAL);
            case 22:
                return textView.setTypeface(Typeface.create("biko", Typeface.NORMAL);
            case 23:
                return textView.setTypeface(Typeface.create("cherryswash", Typeface.NORMAL);
            case 24:
                return textView.setTypeface(Typeface.create("ginora-sans", Typeface.NORMAL);
            case 25:
                return textView.setTypeface(Typeface.create("googlesans-sys", Typeface.NORMAL);
            case 26:
                return textView.setTypeface(Typeface.create("ibmplex-mono", Typeface.NORMAL);
            case 27:
                return textView.setTypeface(Typeface.create("inkferno", Typeface.NORMAL);
            case 28:
                return textView.setTypeface(Typeface.create("instruction", Typeface.NORMAL);
            case 29:
                return textView.setTypeface(Typeface.create("jack-lane", Typeface.NORMAL);
            case 30:
                return textView.setTypeface(Typeface.create("kellyslab", Typeface.NORMAL);
            case 31:
                return textView.setTypeface(Typeface.create("monad", Typeface.NORMAL);
            case 32:
                return textView.setTypeface(Typeface.create("noir", Typeface.NORMAL);
            case 33:
                return textView.setTypeface(Typeface.create("outrun-future", Typeface.NORMAL);
            case 34:
                return textView.setTypeface(Typeface.create("pompiere", Typeface.NORMAL);
            case 35:
                return textView.setTypeface(Typeface.create("reemkufi", Typeface.NORMAL);
            case 36:
                return textView.setTypeface(Typeface.create("riviera", Typeface.NORMAL);
            case 37:
                return textView.setTypeface(Typeface.create("the-outbox", Typeface.NORMAL);
            case 38:
                return textView.setTypeface(Typeface.create("themeable-date", Typeface.NORMAL);
            case 39:
                return textView.setTypeface(Typeface.create("vibur", Typeface.NORMAL);
            case 40:
                return textView.setTypeface(Typeface.create("voltaire", Typeface.NORMAL);
        }
    }
